...
<body class="min-h-screen bg-gray-50">
    ...
    <div class="flex space-x-6 overflow-x-auto pb-4 mb-8">
        ...
        <div class="min-w-[280px] flex-shrink-0 p-6 bg-white rounded-lg shadow-sm card-hover smooth-transition border border-gray-100 cursor-pointer"
             x-on:click="activeTab = 'applications'">
        ...
        <div class="min-w-[280px] flex-shrink-0 p-6 bg-white rounded-lg shadow-sm card-hover smooth-transition border border-gray-100 cursor-pointer"
             x-on:click="activeTab = 'individual'">
            <div class="flex justify-between items-center mb-3">
        ...
        <div class="min-w-[280px] flex-shrink-0 p-6 bg-white rounded-lg shadow-sm card-hover smooth-transition border border-gray-100 cursor-pointer"
             x-on:click="activeTab = 'healthworkers'">
            <div class="flex justify-between items-center mb-3">
