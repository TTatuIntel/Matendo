...
<head>
    ...
    <style>
        ...
        /* Admin-specific gradient for distinction */
        .admin-gradient {
...
<button id="themeToggle" onclick="toggleDarkMode()" class="fixed bottom-4 right-4 z-50 px-3 py-2 rounded-lg bg-gray-900 text-white/90 dark:bg-gray-100 dark:text-gray-900 shadow">🌓</button>
    <!-- Navigation -->
    <nav class="medical-card border-b border-blue-100 sticky top-0 z-40 admin-gradient">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    <a href="{{ route('admin.dashboard') }}"
                       class="nav-link text-white hover:bg-white/20 {{ request()->routeIs('admin.dashboard') ? 'bg-white/20' : '' }}">
                    ...
                    <a href="{{ route('admin.users.index') }}"
                       class="nav-link text-white hover:bg-white/20 {{ request()->routeIs('admin.users*') ? 'bg-white/20' : '' }}">
                        <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.doctors.index') }}"
                       class="nav-link text-white hover:bg-white/20 {{ request()->routeIs('admin.doctors*') ? 'bg-white/20' : '' }}">
                        <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.patients.index') }}"
                       class="nav-link text-white hover:bg-white/20 {{ request()->routeIs('admin.patients*') ? 'bg-white/20' : '' }}">
                        <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.reports.index') }}"
                       class="nav-link text-white hover:bg-white/20 {{ request()->routeIs('admin.reports*') ? 'bg-white/20' : '' }}">
                        <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.settings.index') }}"
                       class="nav-link text-white hover:bg-white/20 {{ request()->routeIs('admin.settings*') ? 'bg-white/20' : '' }}">
                        <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-center space-x-4">
                    <!-- Notifications -->
                    <button class="text-white/80 hover:text-white relative" onclick="toggleNotifications()" id="notificationsButton">
                    ...
                    <div class="relative" id="userMenu">
                        <button class="flex items-center text-white hover:text-gray-200 font-medium" onclick="toggleUserMenu()">
                            <div class="w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white font-bold mr-2">
                        ...
                        <div id="userDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg z-50 border border-gray-200">
                            <div class="py-2">
                                <a href="{{ route('admin.profile.edit') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-t-xl">
                                    <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                    </svg>
                                    Profile Settings
                                ...
                                <a href="{{ route('admin.monitoring.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                    <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Mobile Menu Button -->
                    <button class="md:hidden text-white/80 hover:text-white" onclick="toggleMobileMenu()">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div id="mobileMenu" class="md:hidden mobile-menu fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl">
            ...
            <nav class="p-6 space-y-2">
                <a href="{{ route('admin.dashboard') }}" class="nav-link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }} block text-gray-700">
                    <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2v2zm16 0V9a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2h14a2 2 0 002-2V7z"></path>
                    </svg>
                    Dashboard
                </a>
                <a href="{{ route('admin.users.index') }}" class="nav-link {{ request()->routeIs('admin.users*') ? 'active' : '' }} block text-gray-700">
                    <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m-9 5.197v1a6 6 0 0010.967 0M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                    </svg>
                    Users
                </a>
                <a href="{{ route('admin.doctors.index') }}" class="nav-link {{ request()->routeIs('admin.doctors*') ? 'active' : '' }} block text-gray-700">
                    <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path>
                    </svg>
                    Doctors
                </a>
                <a href="{{ route('admin.patients.index') }}" class="nav-link {{ request()->routeIs('admin.patients*') ? 'active' : '' }} block text-gray-700">
                    <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                    </svg>
                    Patients
                </a>
                <a href="{{ route('admin.reports.index') }}" class="nav-link {{ request()->routeIs('admin.reports*') ? 'active' : '' }} block text-gray-700">
                    <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2-2V7a2 2 0 012-2h2a2 2 0 002 2v2a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 00-2 2h-2a2 2 0 00-2 2v6a2 2 0 01-2 2H9z"></path>
                    </svg>
                    Reports
                </a>
                <a href="{{ route('admin.settings.index') }}" class="nav-link {{ request()->routeIs('admin.settings*') ? 'active' : '' }} block text-gray-700">
                    <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                    </svg>
    ...
    <div id="notificationsPanel" class="hidden fixed top-16 right-4 w-80 bg-white rounded-xl shadow-lg z-50 border border-gray-200">
        <div class="p-4 border-b border-gray-200 flex justify-between items-center">
            <h3 class="font-bold text-gray-900">Admin Notifications</h3>
            <button onclick="markAllAsReadVisually()" class="text-sm text-purple-600 hover:text-purple-800">Mark all as read</button>
        </div>
        ...
        <div class="p-3 border-t border-gray-200 text-center">
            <a href="{{ route('notifications.index') }}" class="text-sm text-purple-600 hover:text-purple-800">View all notifications</a>
        </div>
    </div>
    ...
    <footer class="medical-card border-t border-blue-100 mt-12">
        <div class="max-w-6xl mx-auto px-2 sm:px-4 lg:px-6 py-8">
            <div class="text-center text-gray-600">
                <p>&copy; 2024 Medical Monitor - Admin Portal. All rights reserved.</p>
                <p class="mt-2 text-sm">System administration and user management platform.</p>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        function updateNotificationCounter() {
            ...
            const unreadCount = 0; // This would be populated from server
    ...
    <script src="{{ asset('js/real-time-notifications.js') }}"></script>
