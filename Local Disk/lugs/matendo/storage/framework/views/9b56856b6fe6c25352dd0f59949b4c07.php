            ...
            <div class="min-w-[280px] flex-shrink-0 p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                <div class="flex justify-between items-center mb-3">
                    ...
                    <span class="px-3 py-1 bg-purple-100 text-purple-800 text-xs font-semibold rounded-full">
                        <?php echo e($totalVerifiedWorkers ?? 78); ?>

                    </span>
                </div>
                <p class="text-gray-600 text-sm mb-2">Health workers verified and active on platform.</p>
                <div class="text-xs text-gray-600">
                    <p>New verifications this month: <span class="font-semibold"><?php echo e($newVerificationsThisMonth ?? 8); ?></span></p>
                </div>
            </div>
            ...
            <div class="min-w-[280px] flex-shrink-0 p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                <div class="flex justify-between items-center mb-3">
                    ...
                    <span class="px-3 py-1 bg-red-100 text-red-800 text-xs font-semibold rounded-full">
                        <?php echo e($pendingVerificationWorkers ?? 5); ?>

                    </span>
                </div>
                <p class="text-gray-600 text-sm mb-2">Profiles awaiting background and credential checks.</p>
                <div class="text-xs text-gray-600">
                    <p>Longest pending: <span class="font-semibold"><?php echo e($longestVerificationPending ?? '4 days'); ?></span></p>
                </div>
            </div>
...
</div><?php /**PATH D:\lugs\matendo\resources\views/admin/partials/_healthworkers.blade.php ENDPATH**/ ?>