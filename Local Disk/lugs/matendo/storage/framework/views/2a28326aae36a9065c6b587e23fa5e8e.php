...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="h-40 bg-gray-100 rounded flex items-center justify-center text-gray-400 italic">
            <?php if(isset($applicationTrendsChart)): ?>
                <?php echo $applicationTrendsChart; ?>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="h-40 bg-gray-100 rounded flex items-center justify-center text-gray-400 italic">
            <?php if(isset($facilityRequestsChart)): ?>
                <?php echo $facilityRequestsChart; ?>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="h-40 bg-gray-100 rounded flex items-center justify-center text-gray-400 italic">
            <?php if(isset($healthWorkerActivityChart)): ?>
                <?php echo $healthWorkerActivityChart; ?>
...
</div><?php /**PATH D:\lugs\matendo\resources\views/admin/partials/_reports.blade.php ENDPATH**/ ?>